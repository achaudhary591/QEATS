...
public class RestaurantController {
  ...
  /*
   * @GetMapping(MENU_API) public ResponseEntity<List<ItemEntity>> getMenu(String restaurantId){
   * String uri = MENU_API +
   * 
   * ItemRepository itemRepository; ItemEntity itemEntity = new ItemEntity(); itemRepository =
